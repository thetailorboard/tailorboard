    ...
    <div className="min-h-screen bg-white">
      <section className="bg-gradient-to-r from-blue-900 to-blue-800 text-white py-32 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://play.google.com/store/apps/details?id=com.tailorboard.app" target="_blank" rel="noopener noreferrer" className="bg-yellow-400 text-blue-900 px-8 py-4 rounded-lg font-bold hover:shadow-lg transition text-lg">Download APK</a>
      ...
      <section className="bg-blue-50 py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <a href="https://play.google.com/store/apps/details?id=com.tailorboard.app" target="_blank" rel="noopener noreferrer" className="inline-block bg-blue-900 text-white px-8 py-4 rounded-lg font-bold hover:shadow-lg transition text-lg">Download Now</a>
        </div>
      </section>
    </div>
  );
